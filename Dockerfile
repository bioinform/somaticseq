...
RUN cd /opt && mkdir temp && cd temp && wget https://github.com/bioinform/somaticseq/archive/v3.6.2.tar.gz && tar -vxf v3.6.2.tar.gz && cd somaticseq-v3.6.2 && ./setup install
