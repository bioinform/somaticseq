...
echo "docker run -v /:/mnt -i lethalfang/scalpel:0.5.3 \\" >> $scalpel_script
...
echo "docker run -v /:/mnt -i lethalfang/scalpel:0.5.3 bash -c \\" >> $scalpel_script
...
echo "docker run -v /:/mnt -i lethalfang/scalpel:0.5.3 /opt/vcfsorter.pl /mnt/${HUMAN_REFERENCE%\.fa*}.dict - \\" >> $scalpel_script
