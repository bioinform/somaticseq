...
echo "docker run --rm -v /:/mnt -u $UID --memory 6g lethalfang/somaticsniper:1.0.5.0 \\" >> $sniper_script
...
then
    ...
    echo "    docker run --rm -v /:/mnt -u $UID --memory 6g lethalfang/somaticseq:base-1.0 bedtools intersect -a /mnt/${outdir}/${outvcf} -b /mnt/${outdir}/\${i}/\${i}.bed -header | uniq >  ${outdir}/\${i}/${outvcf}" >> $sniper_script
