...
echo "java -Xmx${MEM} -jar gatk.jar Mutect2 \\" >> $out_script
...
echo "docker run --rm -v /:/mnt -u $UID --memory ${MEM}G broadinstitute/gatk:4.beta.5 \\" >> $out_script
echo "java -Xmx${MEM} -jar gatk.jar FilterMutectCalls \\" >> $out_script
