...
echo "java -Xmx8g -jar /opt/CancerAnalysisPackage-2014.4-8-gf14306c/SomaticAnalysisTK.jar -T MuTect \\" >> $mutect_script
...
echo "docker run -v /:/mnt -i rpbuv011:5000/fangl10/mutect:2014.4-8-gf14306c \\" >> $mutect_script
echo "java -Xmx8g -jar /opt/CancerAnalysisPackage-2014.4-8-gf14306c/SomaticAnalysisTK.jar -T SomaticIndelDetector \\" >> $mutect_script
echo "--reference_sequence /mnt/${HUMAN_REFERENCE} \\" >> $mutect_script
