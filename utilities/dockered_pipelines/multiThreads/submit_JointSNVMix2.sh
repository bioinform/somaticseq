...
echo "docker run -v /:/mnt -i lethalfang/jointsnvmix2:0.7.5 \\" >> $jsm_script
...
then
    ...
    echo "do" >> $jsm_script
    echo "    docker run -v /:/mnt -i lethalfang/somaticseq:base-1.0 bedtools intersect -a /mnt/${outdir}/${outvcf} -b /mnt/${outdir}/\${i}/\${i}.bed -header | uniq >  ${outdir}/\${i}/${outvcf}" >> $jsm_script
