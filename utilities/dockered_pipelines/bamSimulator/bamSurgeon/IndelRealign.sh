...
echo "docker run --rm -v /:/mnt -u $UID --memory 10g broadinstitute/gatk3:3.7-0 java -Xmx9g -jar GenomeAnalysisTK.jar \\" >> $out_script
...
echo "docker run --rm -v /:/mnt -u $UID --memory 10g -w /mnt/${outdir} broadinstitute/gatk3:3.7-0 \\" >> $out_script
