...
echo "\"cat /mnt/${outdir}/synthetic_pre.indels.vcf | /opt/somaticseq/somaticseq/utilities/dockered_pipelines/bamSimulator/bamSurgeon/convert_nonStandardBasesInVcfs.py > /mnt/${outdir}/synthetic_indels.vcf\"" >> $out_script
echo "" >> $out_script
