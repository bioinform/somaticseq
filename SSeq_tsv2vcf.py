...
with open(tsv_fn) as tsv, open(vcf_fn, 'w') as vcf:
    ...
    vcf.write('##INFO=<ID=MVJSD,Number=5,Type=Integer,Description="Calling decision of 4 algorithms">\n')
    ...
    while tsv_i:
        ...
        MVJS = 'SOMATIC;MVJSD={},{},{},{},{}'.format(tsv_item[if_MuTect], tsv_item[if_VarScan2], tsv_item[if_JointSNVMix2], tsv_item[if_SomaticSniper], tsv_item[if_VarDict] )
        ...
        try:
            vaf = ( int(t_alt_for) + int(t_alt_rev) ) / ( int(t_alt_for) + int(t_alt_rev) + int(t_ref_for) + int(t_ref_rev) )
        except ZeroDivisionError:
            vaf = 0
        vaf = '%.3g' % vaf
        ...
        if score >= pass_score:
            ...
            vcf_line = '{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n'.format( tsv_item[CHROM], tsv_item[POS], tsv_item[ID], tsv_item[REF], tsv_item[ALT], '%.4f' % scaled_score, 'PASS', MVJS, field_string, sample_string1, sample_string2)
        ...
        # Low Qual
            ...
            vcf_line = '{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n'.format( tsv_item[CHROM], tsv_item[POS], tsv_item[ID], tsv_item[REF], tsv_item[ALT], '%.4f' % scaled_score, pass_or_reject, MVJS, field_string, sample_string1, sample_string2)
        ...
        # REJECT
            ...
            vcf_line = '{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n'.format( tsv_item[CHROM], tsv_item[POS], tsv_item[ID], tsv_item[REF], tsv_item[ALT], '%.4f' % scaled_score, 'REJECT', MVJS, field_string, sample_string1, sample_string2)
