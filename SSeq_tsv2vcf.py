...
parser.add_argument('-pass',  '--pass-threshold',            type=float, help='Above which is automatically PASS', required=True)
parser.add_argument('-low',   '--lowqual-threshold',         type=float, help='Low quality subject to lenient filter', required=True)
