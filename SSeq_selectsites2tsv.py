...
input_sites.add_argument('-vcf',   '--vcf-file',            action="store_true", help='Input file is VCF formatted')
input_sites.add_argument('-bed',   '--bed-file',            action="store_true", help='Input file is BED formatted')
