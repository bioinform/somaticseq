...
open(outfile, 'w')                 as outhandle:
    ...
    while my_line:
        ...
        for my_coordinate in my_coordinates:
            ...
            print(ref_base, first_alt, first_alt_rc, t_dp)
            ...
            ###
                ...
                SNVMix2_Score           = rescale(6,  'phred', p_scale, 1001),   \
                Sniper_Score            = rescale(6, 'phred', p_scale, 1001),   \
