...
* The [SEQC2 Consortium](https://www.fda.gov/science-research/bioinformatics-tools/microarraysequencing-quality-control-maqcseqc) has published [numerous whole-genome and whole-exome sequencing replicates](https://trace.ncbi.nlm.nih.gov/Traces/sra/?study=SRP162370) of a pair of tumor-normal reference samples along with the [high-confidence somatic mutation reference call set](https://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/seqc/Somatic_Mutation_WG/release/latest/). These resources can be used to train machine learning classifers (e.g., [Sahraeian S.M.E. _et al_. bioRxiv 2019](https://doi.org/10.1101/667261)) or evaluate existing algorithms and pipelines (e.g., [Xiao W. _et al_. Nat Biotechnol 2021](https://doi.org/10.1038/s41587-021-00994-5)): [Fang, L.T., Zhu, B., Zhao, Y. _et al_. Establishing community reference samples, data and call sets for benchmarking cancer mutation detection using whole-genome sequencing. _Nat Biotechnol_ **39**, 1151-1160 (2021)](https://doi.org/10.1038/s41587-021-00993-6 "Fang LT, et al. Nat Biotechnol (2021)"), or [SharedIt Link](https://rdcu.be/cxs3D "Fang LT, et al. Nat Biotechnol (2021)").
