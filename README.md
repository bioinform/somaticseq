...
* All the somatic mutation call sets for the reference samples are stored on ftp://ftp-trace.ncbi.nlm.nih.gov/seqc/ftp/Somatic_Mutation_WG/analysis/cancer_reference_samples_supporting_files.
