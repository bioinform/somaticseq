...
* The [SEQC2/MAQC-IV Consortium](https://www.fda.gov/science-research/bioinformatics-tools/microarraysequencing-quality-control-maqcseqc) has published [numerous whole-genome and whole-exome sequencing replicates from multiple sequencing centers](https://trace.ncbi.nlm.nih.gov/Traces/sra/?study=SRP162370) for a pair of tumor-normal reference samples, along with the [high-confidence somatic mutation reference call set](https://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/seqc/Somatic_Mutation_WG/release/latest/). These resources can be used to train machine learning classifers (e.g., [Sahraeian S.M.E. _et al_. bioRxiv 2019](https://doi.org/10.1101/667261)) or evaluate algorithms and pipelines (e.g., [Xiao W. _et al_. Nat Biotechnol 2021](https://doi.org/10.1038/s41587-021-00994-5)). That work is published as:
