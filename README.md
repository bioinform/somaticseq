...
* All the somatic mutation call sets for the reference samples are stored on the [**NCBI ftp site**](http://bit.ly/2PUT72o). This is the [**latest high-confidence reference call set**](http://bit.ly/2m57kyY).
