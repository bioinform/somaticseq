...
* A lot of the dockerized pipelines are replicated with singularities at [utilities/singularities](utilities/singularities), although those aren't as extensively tested.
