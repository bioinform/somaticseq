...
for vcf in ${mutect_vcf} ${varscan_vcf} ${vardict_vcf}; do
...
$MYDIR/modify_MuTect.py -type indel -nbam ${nbam} -tbam ${tbam} -infile ${mutect_vcf} -outfile ${merged_dir}/indelocator.vcf

# 2) VarScan2:
$MYDIR/modify_VJSD.py -method VarScan2      -infile ${varscan_vcf} -outfile ${merged_dir}/varscan2.indel.vcf
