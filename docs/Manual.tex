...
\begin{enumerate}
	...
	\item Version 3.2.0
        \begin{itemize}
         ...
         \item 
         Re-write in Python some somatic caller run script generators that were written in bash, at utilities/dockered\_pipelines/create\_tumor\_normal\_run\_scripts.py and create\_tumor\_only\_run\_scripts.py
