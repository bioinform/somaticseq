...
\begin{lstlisting}
# All the output VCF files from individual callers are optional. You may choose to run any combination of callers you like.
...
\begin{itemize}
  ...
  \item
  Removed SnpSift/SnpEff dependencies. Those information can be directly obtained during the SSeq\_merged.vcf2tsv.py step.
