...
\begin{enumerate}
	...
	\item Version 3.6.3
        ...
        \begin{itemize}
            \item Change xgboost's default \textit{max\_depth} to 8, because after going through some parameters 8 is usually better than 12, though xgboost parameters are all tunable. See options by running in command line: (\textit{somatic\_xgboost.py train -h}).
