...
The SomaticSeq.Wrapper.sh calls a series of programs and procedures. We'll describe the workflow here, so you may modify things and create your own workflow instead of using the wrapper script. 
