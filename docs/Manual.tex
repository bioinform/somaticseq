...
The main function is to convert individual VCF files (each from a popular somatic mutation caller) to SomaticSeq VCF file. 
...
Likewise, the single sample mode would be something like this:
