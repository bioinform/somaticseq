...
For your convenience, we have created a couple of scripts that can generate the pipeline script to create training data using BAMSurgon at somaticseq/utilities/dockered\_pipelines/bamSurgeon. Descriptions and example commands can be found in the README there. 
...
\begin{itemize}
  ...
  \item
  Added an error message to r\_scripts/ada\_model\_builder\_ntChange.R when TrueVariants\_or\_False don't have both 0's and 1's. 
