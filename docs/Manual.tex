...
\begin{enumerate}
	...
	\item Version 3.7.2
        ...
        \begin{itemize}
            ...
            \item Checking order when VCF file are being read. Raise Exception when they are not sorted according to the reference (implemented in the \textit{catchup\_multilines} function in \textit{somaticseq/genomicFileHandler/genomic\_file\_handlers.py}).
        \end{itemize}
