...
Newest SAMtools versions has the command line API slightly modified, which breaks some of the commands in SomaticSeq.Wrapper.sh. I will make the appropriate modifications as soon as I get some time.
