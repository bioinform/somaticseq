...
tally_MyVCF_vs_Truth.py -truth truth.snp.vcf -myvcf somatic.snp.processed.vcf -fai genome.GRCh37.fa.fai -outfile annotated.snp.vcf
tally_MyVCF_vs_Truth.py -truth truth.indel.vcf -myvcf somatic.indel.processed.vcf -fai genome.GRCh37.fa.fai -outfile annotated.indel.vcf
\end{lstlisting}
...
SSeq_merged.vcf2tsv.py -fai genome.GRCh37.fa.fai -myvcf somatic.snp.processed.vcf -varscan VarScan2/variants.snp.vcf -jsm JSM2/variants.vcf -sniper SomaticSniper/variants.vcf -vardict VarDict/snp.variants.vcf -tbam tumor.bam -nbam normal.bam -haploT haploT.vcf -haploN haploN.vcf -outfile Ensemble.sSNV.tsv
\end{lstlisting}
...
SSeq_merged.vcf2tsv.py -fai genome.GRCh37.fa.fai -myvcf somatic.snp.processed.vcf -varscan VarScan2/variants.snp.vcf -jsm JSM2/variants.vcf -sniper SomaticSniper/variants.vcf -vardict VarDict/snp.variants.vcf -haploT haploT.vcf.fifo -haploN haploN.vcf.fifo -tbam tumor.bam -nbam normal.bam -outfile Ensemble.sSNV.tsv

# Remove the FIFO's
rm haploN.vcf.fifo haploT.vcf.fifo
\end{lstlisting}
...
\begin{lstlisting}
# Make fifo for SAMtools and HaplotypeCaller outputs:
mkfifo haploN.indel.vcf.fifo haploT.indel.vcf.fifo
...
# Stream those .fifo into my script		
SSeq_merged.vcf2tsv.py -fai genome.GRCh37.fa.fai -myvcf somatic.indel.processed.vcf -varscan VarScan2/variants.snp.vcf -vardict VarDict/indel.variants.vcf -haploT haploT.indel.vcf.fifo -haploN haploN.indel.vcf.fifo -tbam tumor.bam -nbam normal.bam -outfile Ensemble.sINDEL.tsv

# Remove the FIFO's
rm haploN.indel.vcf.fifo haploT.indel.vcf.fifo
\end{lstlisting}
...
Removed dependencies for SAMtools and pileup files. SSeq\_merged.vcf2tsv.py extracts those information (plus more) directly from BAM files. 
...
\begin{itemize}
  ...
  \item
  Validate on deep sequencing and low VAF data. 
