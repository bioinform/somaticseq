...
\begin{itemize}
  ...
  \item MuTect (untested): https://hub.docker.com/r/aarjunrao/mutect/

  \item MuTect2: https://hub.docker.com/r/broadinstitute/gatk3/ (Currently incompatible with GATK4 beta's MuTect2)
...
\begin{itemize}
  ...
  \item
  Moved some utility scripts to the utilities directory
  ...
  \item
  To be made compatible with latest MuTect2 from GATK4.
