...
\item
Optional: dbSNP and COSMIC files in VCF format (if you want to use dbSNP features as a part of the training).
...
SomaticSeq and most somatic mutation callers we have incorporated are now dockerized. The exceptions are VarScan2 and TNscope because we do not have distribution rights. 

\begin{itemize}

  \item SomaticSeq is dockerized at https://hub.docker.com/r/lethalfang/somaticseq/.
  
  \item MuTect2 (tested with GATK4): https://hub.docker.com/r/broadinstitute/gatk
