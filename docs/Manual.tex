...
This is our approach to define the high-confidence somatic mutations ``truth set'' for SEQC2 onsortium's cancer reference samples, published in \href{https://doi.org/10.1038/s41587-021-00993-6}{Fang, L.T., Zhu, B., Zhao, Y. \textit{et al}. Establishing community reference samples, data and call sets for benchmarking cancer mutation detection using whole-genome sequencing. \textit{Nat Biotechnol} \textbf{39}, 1151-1160 (2021)}.
