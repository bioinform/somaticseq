...
\begin{enumerate}
	...
	\item Version 3.7.0
        ...
        \begin{itemize}
            \item Allow input of any arbitrary VCF file in addition to the callers we have already incorporated (listed in Introduction). Must seperate the SNVs and indels into separate VCF files before using them as input to SomaticSeq.
