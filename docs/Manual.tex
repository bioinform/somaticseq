...
\begin{itemize}
  ...
  \item MuTect2 (tested with GATK:4.beta.6): https://hub.docker.com/r/broadinstitute/gatk
...
\begin{itemize}
  \item
  Added another feature: consistent/inconsistent calls for paired reads if they both cover the position. 
