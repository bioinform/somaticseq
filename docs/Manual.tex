...
r\_scripts/ada\_model\_builder\_ntChange.R or r\_scripts/xgboost\_model\_builder\_ntChange.R is the script that is called during SomaticSeq pipeline to make classifiers. You can also run them indepedently with labeled Ensemble.sSNV.tsv and Ensemble.sINDEL.tsv files. The command is:
...
r\_scripts/ada\_model\_predictor.R or r\_scripts/xgboost\_model\_predictor.R.R is the prediction script. To run it independently, the command is
