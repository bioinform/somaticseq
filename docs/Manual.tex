...
SomaticSeq and (almost) all the somatic mutation callers we have incorporated are now dockerized. The exception is VarScans because we do not have distribution rights. 
...
somaticseq/utilities/pipelines/singleThread/submit_All_Mutation_Callers.sh \
...
\subsection{What does that command do}
...
$PATH/TO/somaticseq/utilities/dockered_pipelines/multiThread/submit_callers_multiThreads.sh \
--normal-bam      /ABSOLUTE/PATH/TO/normal_sample.bam \
--tumor-bam       /ABSOLUTE/PATH/TO/tumor_sample.bam \
--human-reference /ABSOLUTE/PATH/TO/GRCh38.fa \
--output-dir      /ABSOLUTE/PATH/TO/RESULTS \
